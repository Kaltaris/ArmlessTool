...
local Window = MacLib:Window({
	Title = "Universal Armless Tool",
	Subtitle = "Copy by Kaltaris.",
...
sections.Esp2Section1:Dropdown({
    Name = "Phông chữ",
    Multi = false,
    Required = true,
    Options = fontOptions,
...
sections.UniSection1:Colorpicker({
    Name = "Màu Đường Kẻ",
...
-- Preset Gravity
sections.Pla2Section1:Dropdown({
    Name = "Mức Trọng Lực",
    Default = 1,
    Options = {
        "Rơi Chậm (25)",
